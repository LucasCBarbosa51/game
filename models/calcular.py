...
class Calcular:
    """
    Classe calcular efetua a geração de valores aleatórios de acordo com uma determinada dificuldade:
    args:
        - dificuldade: nivel de dificuldade do jogo.
        - valor1: Valor aleatório inteiro.
        - valor2: valor aleatório inteiro.
        - operacao: tipo de operação, 1 = soma, 2 = subtração e 3: multiplicar
    """
